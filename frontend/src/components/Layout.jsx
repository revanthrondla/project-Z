...
const adminNav = [
  ...
  { to: '/projects',   icon: '📁', label: 'Projects',                           moduleKey: 'hr_timesheets' },
  { to: '/expenses',   icon: '🧾', label: 'Expenses',                           moduleKey: 'hr_timesheets' },
  { to: '/timesheets', icon: '⏱️', label: 'Timesheets',                         moduleKey: 'hr_timesheets' },
  { to: '/attendance', icon: '📍', label: 'Attendance',                         moduleKey: 'hr_timesheets' },
  { to: '/absences',   icon: '🏖️', label: 'Absences',                           moduleKey: 'hr_absences' },
  { to: '/holidays',   icon: '🎉', label: 'Public Holidays',                    moduleKey: 'hr_absences' },
...
const candidateNav = [
  ...
  { to: '/expenses',        icon: '🧾', label: 'My Expenses',                      moduleKey: 'hr_timesheets' },
