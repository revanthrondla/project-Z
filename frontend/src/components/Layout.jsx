...
const adminNav = [
  ...
  { to: '/projects',   icon: '📁', label: 'Projects',                           moduleKey: 'hr_projects' },
  { to: '/expenses',   icon: '🧾', label: 'Expenses',                           moduleKey: 'hr_expenses' },
  { to: '/timesheets', icon: '⏱️', label: 'Timesheets',                         moduleKey: 'hr_timesheets' },
  { to: '/attendance', icon: '📍', label: 'Attendance',                         moduleKey: 'hr_attendance' },
  { to: '/absences',   icon: '🏖️', label: 'Absences',                           moduleKey: 'hr_absences' },
  { to: '/holidays',   icon: '🎉', label: 'Public Holidays',                    moduleKey: 'hr_attendance' },
  ...
  { to: '/contractors',            icon: '🤝', label: 'Contractors',      section: 'Compliance', moduleKey: 'hr_contractors' },
  { to: '/compliance',             icon: '⚖️', label: 'Compliance Center',       moduleKey: 'hr_compliance' },
  { to: '/eeo',                    icon: '🏛️', label: 'EEO Reporting',           moduleKey: 'hr_eeo' },
  ...
  // ── Payroll & Tools ─────────────────────────────────────────────────────────
  { to: '/payroll-reconciliation', icon: '💰', label: 'Payroll',        section: 'Payroll & Tools', moduleKey: 'hr_payroll' },
...
const candidateNav = [
  ...
  { to: '/clock',           icon: '📍', label: 'Clock In/Out',                  moduleKey: 'hr_timesheets' },
  { to: '/expenses',        icon: '🧾', label: 'My Expenses',                      moduleKey: 'hr_expenses' },
